        ...
        <div class="details">
          ...
          <div>
            ...
            <form method="post">
              ...
              <div>
                <input value="" type="text" name="phone" placeholder="Phone Number" />
              </div>
              <div class="row">
    ...
    <div class="content radiology__center inactive">
      <div class="row">
          ...
          <div>
            ...
            <div class="message__row message">
              <div class="img__name">
                ...
                <div class="name__message">
                  <h6>{{$center->firstname . " " . $center->secondname}}</h6>
                  <p>{{$center->email}}</p>
                </div>
              </div>
              <div class="date__unread">
                <p class="date">{{$center->date}}</p>
                <p class="unread"></p>
              </div>
            </div>
            @empty
        ...
        <div class="details">
          ...
          <div>
            <form method="post" action="{{route('dentist.request')}}">

              @csrf
              <div>
                <input type="email" name="center_email" placeholder="Radiology Center Email" />
              </div>
              <div>
